...
<head>
    ...
    <link rel="icon" href="../../assets/img/bank.png" type="image/x-icon">
    <title>Profile - Dhiraj Bank </title>
        ...
        <nav class="navbar-side sidebar">
            <div class="nav-container">
                <a class="navbar-brand" href="./index.php">
                    ...
                    <div class="sidebar-brand-text"><span>Dhiraj Bank</span></div>
                </a>
                ...
                <ul class="navbar-nav" id="sidebar-ul">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../scripts/bankut.php">
